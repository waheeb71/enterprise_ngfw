...
from core.log_manager import setup_terminal_logging
setup_terminal_logging()

# Import the core engine
from core.engine import NGFWApplication
...
async def async_main():
    ...
    parser.add_argument('-c', '--config', type=Path, default=Path('/etc/ngfw/config.yaml'), help='Configuration API Path')
